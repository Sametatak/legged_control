...
def generate_launch_description():
    ...
    # ---------------------------------------------------------
    # YENİ NODE 1: Gait Generator (Yörünge Üretici)
    ...
    # ---------------------------------------------------------
    # YENİ NODE 2: Inverse Kinematics (Ters Kinematik)
    ...
    simple_ik_node = Node(
        ...
        remappings=[
            ("joint_group_position_controller/command", LaunchConfiguration("joint_controller_topic"))
        ]
    )
